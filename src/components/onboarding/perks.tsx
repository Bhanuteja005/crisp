            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    ...
                    <p className="text-base md:text-lg text-center text-black mt-6">
                        Discover the powerful advantages of our AI-powered interview platform for efficient candidate evaluation
                    </p>
                </div>
            </Container>
            <Container>
        ...
        >
            ...
            <div className="group-hover/feature:-translate-y-1 transform-gpu transition-all duration-300 flex flex-col w-full">
                <div className="mb-4 relative z-10 px-10">
                    <Icon strokeWidth={1.3} className="w-10 h-10 origin-left transform-gpu text-black transition-all duration-300 ease-in-out group-hover/feature:scale-75 group-hover/feature:text-black" />
                </div>
                <div className="text-lg font-medium font-heading mb-2 relative z-10 px-10">
                    ...
                    <span className="group-hover/feature:-translate-y- group-hover/feature:text-black transition duration-500 inline-block text-black">
                        {title}
                    </span>
                </div>
